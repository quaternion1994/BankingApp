...
using BankingAppNew.Web.Results;
...
namespace BankingAppNew.Web.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public AccountController(BankUserManager userManager, ISecureDataFormat<AuthenticationTicket> accessTokenFormat)
        {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            BankAccount user = await UserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
